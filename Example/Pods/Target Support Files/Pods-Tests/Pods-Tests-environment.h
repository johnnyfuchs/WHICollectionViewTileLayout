...
#define COCOAPODS_POD_AVAILABLE_WHICollectionViewTileLayout
#define COCOAPODS_VERSION_MAJOR_WHICollectionViewTileLayout 0
#define COCOAPODS_VERSION_MINOR_WHICollectionViewTileLayout 1
#define COCOAPODS_VERSION_PATCH_WHICollectionViewTileLayout 0
